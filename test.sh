...
# =============================
# CyberPie ULTRA • PRO • MAX VM Manager
# =============================

# Function: display animated banner
display_banner() {
    clear
    echo -e "\e[1;96m"
    cat << "EOF"
  ...
  ╚═╝      ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝     
EOF
    echo -e "\e[1;93m        🚀 CyberPie ULTRA • PRO • MAX VM Manager 🚀\e[0m"
    echo -e "\e[1;95m        Sponsored by: HOPINGBOYZ | Jishnu | NotGamerPie\e[0m"
    echo
}
